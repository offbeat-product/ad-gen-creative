...
const VideoResizeResult = ({ job, assets, jobId, selectedFormats, onStartNew }: Props) => {
    ...
    <div className="rounded-xl border bg-card p-5 space-y-4">
      ...
      {isRunning && (
        <div className="space-y-2">
          ...
          />
          <div className="text-[11px] text-muted-foreground">全体で2〜5分ほどかかります</div>
        </div>
      )}
      ...
      {pendingAssets.length > 0 && (
        <div className="space-y-2">
          <div className="text-xs font-semibold text-muted-foreground">生成中のフォーマット</div>
