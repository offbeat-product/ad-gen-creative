          ...
          return (
            <div
              ...
              className={cn(
                ...
                (isDone || isSkipped || hasError || isRunning) && "cursor-pointer",
                isDone && "hover:bg-success-wash/50",
                isSkipped && "opacity-60",
                isSelected && isDone && "bg-secondary-wash border-l-[3px] border-secondary",
                isSelected && (hasError || isRunning || isSkipped) && "border-l-[3px] border-secondary",
